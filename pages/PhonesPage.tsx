...
const allBrands = ['הכל', ...new Set(phoneProducts.map(p => p.brand))];

const PhonesPage: React.FC<PhonesPageProps> = ({ onAddToCart, onViewDetails, onBack, onAddToCartWithVariants }) => {
